...
namespace IronMeridian.UI
{
    ...
    public class SupplyPanelUI : MonoBehaviour
    {
        ...
        RectTransform _panel, _listContent, _stockFill;
        ...
        void BuildStockBlock()
        {
            ...
            UIFactory.PlaceTopLeft(_serviceText.rectTransform, Pad, 138f,
                UiTheme.RightPanelWidth - Pad * 2f, 34f);

            _reachText = UIFactory.CreateText(_panel, "", UiTheme.FontLabel, UiTheme.TextFaint,
                TextAnchor.UpperLeft);
            UIFactory.PlaceTopLeft(_reachText.rectTransform, Pad, 174f,
                UiTheme.RightPanelWidth - Pad * 2f, 16f);

            var remove = UIFactory.CreateBorderedPanel(_panel, "RemoveSite",
                UiTheme.Surface, UiTheme.Border);
            UIFactory.PlaceTopLeft(remove, Pad, 196f, UiTheme.RightPanelWidth - Pad * 2f, 28f);
        ...
        void BuildList()
        {
            ...
            UIFactory.PlaceTopLeft(_inRangeText.rectTransform, Pad, 238f,
                UiTheme.RightPanelWidth - Pad * 2f, 14f);
            ...
            rt.offsetMax = new Vector2(-Pad, -258f);
            ...
            _emptyNote = UIFactory.CreateText(_panel, "", UiTheme.FontLabel, UiTheme.TextFaint,
                TextAnchor.UpperLeft);
            UIFactory.PlaceTopLeft(_emptyNote.rectTransform, Pad, 262f,
        ...
        void RefreshService(LogisticsDef def)
        {
            _serviceText.text = def.service switch
            {
                ...
                SupplyService.General => "Rearms, refuels and treats, at a reduced rate.",
                _ => "Drawn on the map. This kind does not issue anything yet."
            };

            _reachText.text = $"REACHES {def.serviceRadiusKm:0.#} KM  ·  " +
                              "a formation inside it draws automatically, in battle";
        }
        ...
        static bool Wants(UnitActor unit, LogisticsDef def)
        {
            ...
            return def.service switch
            {
                ...
                SupplyService.General => ammo || fuel || hurt,
                _ => false
            };
        }
        ...
        static string Shortfall(UnitActor unit)
        {
            ...
            string fuel = unit.Def.fuelStock > 0.01f
                ...
                : "FUEL —";
            return $"{ammo}  ·  {fuel}  ·  STR {unit.State.strength * 100f:0} %";
        }
